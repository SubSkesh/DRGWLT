...
import 'package:drgwallet/tabs/wallet_tab.dart';
import 'package:drgwallet/tabs/agents_tab.dart';
...
//todo radial menu is not necessary
    ...
    return Scaffold(
      ...
      bottomNavigationBar: CustomBottomNavigationBar(
        ...
        actions: [
          ...
          BottomNavigationBarItem(
            icon: ImageIcon(Image.asset('assets/icons/discussion_meeting_people_icon.png').image),
            label: 'Agents',
          ),
          BottomNavigationBarItem(
...
//todo: uncomment this if you are in trouble,itworks as a scaffold
//     return Scaffold(
//       appBar: AppBar(
